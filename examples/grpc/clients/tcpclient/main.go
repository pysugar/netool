...
import (
	...
	"github.com/pysugar/netool/grpc/tcpclient"
...
func main() {
	...
	client, err := tcpclient.NewGRPCClient(serverURL)
	if err != nil {
		log.Fatal(err)
	}
...
func callHealthCheck(ctx context.Context, client tcpclient.GRPCClient, contextPath string) {
